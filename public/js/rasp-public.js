	...
	class Event {
		constructor(event) {
			try {
				...
				//console.log(this.event_data.e_begin_time_formated);
				...
				if (this.e_offset < 0)
					this.event_data.e_begin_time_formated = this.event_data.e_begin_time_formated + 70000; //value is in use for sorting events array get BegTimeForm.
				//console.log(this.event_data.e_begin_time_formated);
		...
		get BegTimeForm() {
			return this.event_data.e_begin_time_formated;
		}
