...
class Rasp_Public {
	...
	public function enqueue_filters(){
		//error_log("Class rasp public  enqueue_filters()" . __FILE__ . '  ' . __LINE__);
		//add_filter('the_content','Display::display_rasp_table');
	}

	public function __toString()
	{
			return 'class Rasp_Public';
	}
